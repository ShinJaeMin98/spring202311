...
public class JdbcTemplateTest {
    ...
    void InsertTest() {
        // DataAcceccException - RuntimeException - 예외처리 X -> 실행
        String sql = "INSERT INTO MEMBER (USER_NO, USER_ID, USER_PW, USER_NM, EMAIL)" +
                    "VALUES (SEQ_MEMBER.nextval, ?, ?, ?, ?)";
        int affectedRows = jdbcTemplate.update(sql, "USER4", "123456", "사용자4", "user4@test.org");
    ...
    void InserTest2() {
        ...
        int affactedRows = jdbcTemplate.update((con) -> {

                   String sql = "INSERT INTO MEMBER (USER_NO, USER_ID, USER_PW, USER_NM, " +
                           "EMAIL) VALUES (SEQ_MEMBER.nextval, ?, ?, ?, ?)";
                   ...
                   pstmt.setString(3, "사용자5");
                   pstmt.setString(4, "user5@test.org");
